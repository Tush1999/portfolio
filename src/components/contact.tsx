      ...
      <div>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="form-container">
          <div className="name-email-container">
            <div><input type="text" name={NAME_FORM_VALUE} value={formValues[NAME_FORM_VALUE]} placeholder="Name" onChange={handleChange} required  /></div>
            <div><input type="email" name={EMAIL_FORM_VALUE} value={formValues[EMAIL_FORM_VALUE]} placeholder="Email" onChange={handleChange} required /></div>
          </div>
